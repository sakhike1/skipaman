            ...
            <div class="mt-8">
                <form action="#" autoComplete="off">
                    ...
                    <div class="flex w-full">
                        <button type="submit"
                            class="glow-on-hover  py-2 px-4  bg-gradient-to-r from-slate-500 to-yellow-100 hover:bg-purple-700 focus:ring-purple-500 focus:ring-offset-purple-200 text-gray-100 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            Create Account
                        </button>
                    </div>
                </form>
...
<script>
import VideoTwo from '@/components/Ul/VideoTwo.vue';
export default {
    components: {
        VideoTwo
    },
